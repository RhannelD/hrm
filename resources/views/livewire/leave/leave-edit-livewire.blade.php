            ...
            <div class="modal-content">
                <div class="modal-header bg-dark text-white">
                    <h5 class="modal-title" id="attendance-modal-label">
                        Leave {{ isset($attendance_id)? 'Editing': 'Creating' }}
                    </h5>
                ...
                <div class="modal-body">
                    ...
                    <div wire:loading.remove wire:target='set_attendance, unset_attendance'>
                        <div class="form-group" >
                            <label for="attendance">Leave</label>
                            <input wire:model.lazy='attendance.attendance' type="text" class="form-control" id="attendance" placeholder="Leave">
                        ...
                        <div class="form-group" >
                            ...
                            <div class="input-group">
                                <input wire:model.lazy='attendance.payment' type="number" class="form-control" id="payment" placeholder="Payment in %" aria-describedby="payment-addon">
