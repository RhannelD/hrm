...
class AttendanceEditLivewire extends Component
{
    ...
    protected $messages = [
        ...
        'attendance.attendance.unique' => 'The attendance name has already been taken on attendances and leaves.',
    ];
    ...
    {
        return view('livewire.attendance.attendance-edit-livewire');
    }
    ...
    public function save()
    {
        ...
        if ( $attendance->wasRecentlyCreated ) {
            $this->dispatchBrowserEvent('swal:modal', [
                ...
                'text' => 'Attendance has been successfully created'
            ]);
